          ...
          <div className="grid lg:grid-cols-2 gap-16 items-stretch">
            ...
            <div className="h-full flex flex-col">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-4xl font-serif">Let's Get Started</h2>
              </div>
              
              <p className="text-xl text-accent mb-12">
                Ready to transform your space into something extraordinary? Visit our factory outlet in Nashik or reach out to us. Our design experts are here to make your dream home a reality.
              </p>
                ...
                <div className="group">
                  <div className="relative p-6 bg-secondary/10 backdrop-blur-sm rounded-xl border border-secondary/20 hover:border-secondary/50 transition-all duration-300">
                    ...
                    <div className="flex items-start">
                      ...
                      <div className="ml-4">
                        <h3 className="text-lg font-medium mb-2">Visit Our Factory Outlet</h3>
                        <p className="text-accent">MR Traders & Factory Outlet,<br />Nilgiri Baug, Sambhaji Nagar Road,<br />Nandura Naka, Nashik - 422003</p>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="group">
                  <div className="relative p-6 bg-secondary/10 backdrop-blur-sm rounded-xl border border-secondary/20 hover:border-secondary/50 transition-all duration-300">
                    ...
                    <div className="flex items-start">
                      ...
                      <div className="ml-4">
                        <h3 className="text-lg font-medium mb-2">Call / WhatsApp Us</h3>
                        <a href="tel:+919423640903" className="text-accent hover:text-secondary transition-colors">
                          +91 9423640903
                        </a>
                      </div>
                    </div>
                  ...
                  <div className="relative p-6 bg-secondary/10 backdrop-blur-sm rounded-xl border border-secondary/20 hover:border-secondary/50 transition-all duration-300">
                    ...
                    <div className="flex items-start">
                      ...
                      <div className="ml-4">
                        ...
                        <a href="mailto:mrtradersofficial01@gmail.com" className="text-accent hover:text-secondary transition-colors break-all">
