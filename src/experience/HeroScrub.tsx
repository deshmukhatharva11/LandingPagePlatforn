  ...
  return (
    <div className="dp-exp">
      <div className="dp-exp__viewport">
        ...
        <header className="dp-exp__bar" style={{ justifyContent: 'center', paddingTop: '8vh' }}>
          <img
            src="/favicon.png"
            alt="MR Traders"
        ...
        <div ref={act1Ref} className="dp-exp__act dp-exp__act--1">
          <p className="dp-exp__eyebrow">
            <span className="dp-exp__line">Nashik &middot; Factory Outlet &amp; Interior Studio</span>
          </p>
          <h1 className="dp-exp__title">
            <span className="dp-exp__line">Your Home Deserves</span>
            <br />
          ...
          <p className="dp-exp__sub">
            <span className="dp-exp__line">Scroll to see what we build.</span>
          </p>
        </div>
        ...
        <div ref={act2Ref} className="dp-exp__act">
          <h2 className="dp-exp__title">
            Premium materials,
            <br />
            <em>factory-direct prices.</em>
          </h2>
        </div>

        <div ref={act3Ref} className="dp-exp__act">
          <h2 className="dp-exp__title">
            1000+ homes built.<br /><em>Yours is next.</em>
          </h2>
          <p className="dp-exp__sub">
            <span className="dp-exp__line">MR Traders, Nashik &mdash; Step inside &rarr;</span>
          </p>
        </div>
