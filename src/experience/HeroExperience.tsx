    ...
    <div className="dp-exp">
      <div className="dp-exp__viewport">
        ...
        <header className="dp-exp__bar">
          ...
          <span className="dp-exp__tag">MR Traders &middot; Experience &mdash; proof of concept</span>
        </header>
        ...
        <div ref={act1Ref} className="dp-exp__act dp-exp__act--1">
          <p className="dp-exp__eyebrow">
            <span className="dp-exp__line">Nashik &middot; Architecture &amp; Interiors</span>
          </p>
