export const TIER_SPECIFICATIONS = {
    executiveSummary: "This document mirrors the exact logic used in the MR Traders Construction Cost Calculator. It details the 8-Tier Hierarchy from Civitas (Economy) to Sovereign (Estate), including the new Veridia (Sustainable) tier.",
    pricingHierarchy: [
