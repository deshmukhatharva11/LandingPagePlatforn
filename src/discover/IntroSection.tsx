...
export default function IntroSection() {
  return (
    <div className="w-full max-w-3xl mx-auto text-center">
      ...
      >
        MR Traders · Design Your Home
      </motion.p>

      <h1 className="font-serif font-light text-white text-[2.3rem] leading-[1.1] sm:text-5xl md:text-6xl mb-6">
        <KineticText text="Tell us what you're looking for." highlight={["you're"]} trigger="inView" stagger={0.09} />
      </h1>
      ...
      >
        Answer a few quick questions so our team can prepare the perfect design plan for your home — no obligation.
      </motion.p>
