      ...
      <div className="relative aspect-[4/5]">
        {p.video ? (
          <video
            ...
            playsInline
            autoPlay
            className="absolute inset-0 h-full w-full object-cover transition-transform duration-700 group-hover:scale-105 bg-black/40"
          />
        ) : (
          <img
            src={p.image}
    ...
    <div className="dp-showcase relative min-h-svh text-white font-sans">
      ...
      <div className="relative z-10">
        ...
        <section id="reviews" className="mx-auto max-w-6xl px-5 py-16 sm:px-6 scroll-mt-20">
          <h3 className="mb-8 text-center font-serif text-2xl sm:text-3xl">Loved by homeowners across Nashik</h3>
          <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3">
