...
const BEDROOM: StyleOption[] = [
  { id: 'bedroom-minimal', philosophy: 'Modern Minimal', title: 'Calm & Clean', blurb: 'Low-profile bed, soft light, zero clutter.', image: '/images/discover/wardrobe-minimal.jpg', palette: ['#E7E2D8', '#B9AE9B', '#6E6354'], traits: ['low bed', 'minimal', 'soft lighting', 'neutral tones'] },
  { id: 'bedroom-luxe', philosophy: 'Luxe Comfort', title: 'Grand & Plush', blurb: 'Upholstered headboard, mood lighting, layered textures.', image: '/images/discover/wardrobe-luxe.jpg', palette: ['#2B2B2D', '#8A8D8F', '#C9A24B'], traits: ['upholstered', 'mood lighting', 'plush', 'dark tones'] },
  { id: 'bedroom-warm', philosophy: 'Warm Wood', title: 'Cozy & Natural', blurb: 'Rich wood tones, warm fabrics, earthy vibes.', image: '/images/discover/wardrobe-wood.jpg', palette: ['#6B4F2F', '#A47B4E', '#E2C79B'], traits: ['wood panel', 'warm', 'earthy', 'natural fabrics'] },
  { id: 'bedroom-classic', philosophy: 'Classic Indian', title: 'Traditional & Rich', blurb: 'Carved details, rich colours, timeless elegance.', image: '/images/discover/wardrobe-european.jpg', palette: ['#EDEAE3', '#9FB38F', '#5B4631'], traits: ['carved wood', 'rich fabrics', 'traditional', 'ornate'] },
];

export const STEPS: Step[] = [
  {
    kind: 'choice', id: 'home', kicker: 'Your Home', question: 'What type of home are we designing?', why: 'So we plan around your building\'s structure.',
    options: [
      { id: 'apartment', label: 'Apartment', hint: 'Flat / gated community' },
      { id: 'villa', label: 'Villa / Row House' },
  ...
  { kind: 'visual', id: 'living', room: 'Living Room', question: 'How should your living room feel?', options: LIVING },
  { kind: 'visual', id: 'kitchen', room: 'Kitchen', question: 'Which kitchen style speaks to you?', options: KITCHEN },
  { kind: 'visual', id: 'bedroom', room: 'Bedroom', question: 'Pick your dream bedroom vibe.', options: BEDROOM },
  { kind: 'visual', id: 'wardrobe', room: 'Wardrobe', question: 'How should your wardrobe feel?', options: WARDROBE },
  {
    ...
    options: [
      { id: 't1', label: 'Moving in soon', hint: 'Within 1 month' },
  ...
  {
    kind: 'choice', id: 'budget', kicker: 'Budget', question: 'What budget feels right for your interiors?', why: 'It helps us match materials and finishes to your range — no obligation.',
    options: [
      { id: 'b1', label: 'Under ₹5 Lakh', hint: 'Essentials' },
      { id: 'b2', label: '₹5 – 10 Lakh', hint: 'Comfort' },
      { id: 'b3', label: '₹10 – 20 Lakh', hint: 'Premium' },
